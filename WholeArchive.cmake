...
function(make_archive_whole archive_name archive_output)
	...
	elseif (TARGET_COMPILER_CLANG OR TARGET_COMPILER_GCC)
		if (GENERATOR_IS_MULTI_CONFIG)
			set(${archive_output} "-Wl,--whole-archive ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/$(Configuration)/${archive_name} -Wl,--no-whole-archive" PARENT_SCOPE)
		else()
			set(${archive_output} "-Wl,--whole-archive ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${archive_name} -Wl,--no-whole-archive" PARENT_SCOPE)
		endif()
	else()
