...
GS_Input VSMain(float4 position
				: POSITION, float4 normal
				: NORMAL, float4 texCoord
				: TEX_COORD) {
	GS_Input result;
...
[maxvertexcount(3)] void GSMain(triangle GS_Input input[3], inout TriangleStream<PS_Input> OutputStream) {
