...
protected:
	...
	public:
		...
		ConstBufferPage(std::unique_ptr<gxapi::IResource>&& representedMemory, void* cpuAddress, void* gpuAddress, size_t pageSize, size_t ownerFrameID) : m_representedMemory(std::move(representedMemory)),
