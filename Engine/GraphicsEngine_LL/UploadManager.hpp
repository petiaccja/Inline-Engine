...
public:
	...
	void Upload(std::weak_ptr<Texture2D> target, uint32_t offsetX, uint32_t offsetY, const void* data, uint64_t width, uint32_t height, gxapi::eFormat format, size_t bytesPerRow = 0);
