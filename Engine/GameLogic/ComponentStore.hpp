...
///		To be used ONLY for the <see cref="ComponentStore"/>. </summary>
...
public:
	...
	template <class... Components>
	void SpliceBackExtend(ComponentStore& other, size_t index, Components&&... extraComponents);
	...
	void SpliceBackReduce(ComponentStore& other, size_t index, const std::vector<bool>& selection);
	...
	/// <summary> Creates an ComponentStore with the exact same component vectors as this, but with all vectors empty. </summary>
	ComponentStore CloneScheme() const;
...
template <class... Components>
void ComponentStore::PushBack(Components&&... components) {
...
template <class... Components>
void ComponentStore::SpliceBackExtend(ComponentStore& other, size_t index, Components&&... extraComponents) {
...
template <class ComponentType>
void ComponentStore::Extend(std::initializer_list<ComponentType>& data) {
...
template <class ComponentT>
const ContiguousVector<ComponentT>& ComponentStore::GetComponentVector(size_t index) const {
...
template <size_t Index, class... ComponentT>
void ComponentStore::PushBackHelper(const std::tuple<ComponentT...>& components, const std::array<size_t, sizeof...(ComponentT)>& reorder) {
